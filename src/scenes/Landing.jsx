            ...
            <div className="z-30 basis-2/5 mt-12 md:mt-32">
                ...
                >
                    ...
                    <p className="mt-12 mb-7 text-sm text-center md:text-start">
                        Daenerys Targaryen, Filha da Tormenta, a Não Queimada, Mãe de Dragões, Rainha de Mereen,
                        Rainha dos Ândalos e dos Primeiros Homens, Quebradora de Correntes, Senhora dos Sete Reinos,
                        Khaleesi dos Dothraki, a Primeira de Seu Nome
                    </p>
                    ...
                    >
                        ...
                        >
                            <div
                                className="bg-deep-blue hover:text-red transition duraiton-500 w-full h-full flex items-center
